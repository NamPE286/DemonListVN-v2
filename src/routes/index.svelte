...
<div class={toggleMenu ? 'sidebar' : 'sidebar1'} id='sidebarDiv'>
    <a href='#!'>
        <div class={showHightlight('list')} id='sidebarIcon'>
    ...
    <hr>
    <a href='#!' class='bottomIcon'>
        <div class={showHightlight('settings')} id='sidebarIcon'>
    ...
    <a href='#!'>
        <div class={showHightlight('info')} id='sidebarIcon'>
