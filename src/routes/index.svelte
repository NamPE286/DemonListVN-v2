...
<div class="sidebar">
    ...
    <p class={showTitle('list')}>List</p>
    <a href='#!' class='bottomIcon'>
        <div class={showHightlight('settings')}>
    ...
    <p class={showTitle('settings')}>Settings</p>
    <a href='#!'>
        <div class={showHightlight('info')}>
