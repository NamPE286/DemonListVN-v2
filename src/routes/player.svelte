...
{#if player}
	...
	<div class="pageContent">
		<div class="playerInfoWidget">
			...
			<div class="social">
				<a href={player.data.youtube ? player.data.youtube : '#!'} target="_blank" class="iconWrapper">
					<svg
						id="youtube"
				...
				<a href={player.data.facebook ? player.data.facebook : '#!'} target="_blank" class="iconWrapper">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="39.398"
						height="39.398"
			...
			<div class="playersListWrapper">
				...
				{#each dlrec as item, index}
					<div class="playersList" id={index % 2 ? "" : "highlight2"}>
						<div class="playerName">
							<a href={`/level?id=${item.levelid}`}>{item.levels.name} ({item.refreshRate}fps)</a><a href={item.videoLink} target='_blank' id='videoLink'>(Video Link)</a>
						</div>
						<div class="playerPt">
